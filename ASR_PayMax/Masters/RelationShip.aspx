<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="RelationShip.aspx.cs" Inherits="ASR_PayMax.Masters.RelationShip" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">RelationShip Master</li>
        </ol>
    </section>--%>
        ...
        <div class="card-body">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">&nbsp;&nbsp;RelationShip Details</h3>
                </div>
                <div class="card-body">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" CssClass="form-control RoundText" ID="txtRelationShip"></asp:TextBox>
                                       <input id="hddRelationID" type="hidden" runat="server" value="0" />
                                   </div>
                                </div>
                            </div>
                        ...
                        <asp:Button ID="Btn_Cancel" runat="server" Text="Reset" CssClass="btn btn-danger" OnClick="Btn_Cancel_Click" />
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="GridRelationShip" EventName="RowCommand" />
                                </Triggers>
                                <ContentTemplate>
                                    <asp:GridView ID="GridRelationShip" OnRowCommand="GridRelationShip_RowCommand" runat="server" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="RelationshipMasterID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRelationshipMasterID" Text='<%# Eval("RelationshipMasterID") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Relationship Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblRelationshipName" runat="server" Text='<%# Eval("RelationshipName") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
