<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="Duty.aspx.cs" Inherits="ASR_PayMax.Masters.Duty" %>
        ...
        <div class="card-body">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="GridDuty" EventName="RowCommand" />
                </Triggers>
                <ContentTemplate>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtDutyName" CssClass="form-control RoundText"></asp:TextBox>
                                <input id="hddDutyID" type="hidden" runat="server" value="0" />
                            </div>
                        </div>
                    </div>
                    ...
                    <hr />
                    <asp:GridView ID="GridDuty" runat="server" OnRowCommand="GridDuty_RowCommand" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="DutyID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblDutyID" Text='<%# Eval("DutyMasterID") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Duty Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblDutyName" runat="server" Text='<%# Eval("DutyName") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
