<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="Languages.aspx.cs" Inherits="ASR_PayMax.Masters.Languages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <asp:Label CssClass="lblText" runat="server" Text="Language Type"></asp:Label>&nbsp;&nbsp;<span class="star">*</span>
                                        <asp:TextBox runat="server" CssClass="form-control RoundText" ID="txtLanguageType"></asp:TextBox>
                                        <input id="hddLanguageID" type="hidden" runat="server" value="0" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="GridLanguage" EventName="RowCommand" />
                                </Triggers>
                                <ContentTemplate>
                                    <asp:GridView ID="GridLanguage" OnRowCommand="GridLanguage_RowCommand" runat="server" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="LanguageMasterID" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblLanguageMasterID" Text='<%# Eval("LanguageMasterID") %>' runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
        ...
        function auto() {
            ...
            GridMasters('<%=GridLanguage.ClientID%>', '', '', '', '', '', '', '', '', '');
        }
    </script>
</asp:Content>
