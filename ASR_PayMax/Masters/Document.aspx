<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="Document.aspx.cs" Inherits="ASR_PayMax.Masters.Document" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <%-- <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Document Master</li>
        </ol>
    </section>--%>
        ...
        <div class="card-body">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="GridDocument" EventName="RowCommand" />
                </Triggers>
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtDocumentName" CssClass="form-control RoundText"></asp:TextBox>
                                <input id="hddDocumentID" type="hidden" runat="server" value="0" class="hide" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label CssClass="lblText" runat="server" Text="Is Compulsary"></asp:Label><br />
                                <asp:CheckBox ID="chkIsCompulsary" runat="server"  CssClass="custom-checkbox" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                <asp:Label CssClass="lblText" runat="server" Text="Is Statuary Type"></asp:Label><br />
                                <asp:CheckBox ID="chkIsStatuary" runat="server" CssClass="custom-checkbox" />
                            </div>
                        </div>
                    </div>
                    ...
                    <hr />
                    <asp:GridView ID="GridDocument" runat="server" OnRowCommand="GridDocument_RowCommand" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
