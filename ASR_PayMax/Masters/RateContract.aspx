<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="RateContract.aspx.cs" Inherits="ASR_PayMax.Masters.RateContract" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Rate Contract Master</li>
        </ol>
    </section>--%>
        ...
        <div class="card-body">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">&nbsp;&nbsp;Rate Contract Details</h3>
                </div>
                <div class="card-body">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <asp:Label CssClass="lblText" runat="server" Text="Rate Contract Code"></asp:Label>
                                        <asp:TextBox runat="server" CssClass="form-control RoundText" ID="txtRateContractCode"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <asp:Label CssClass="lblText" runat="server" Text="Rate Contract Name"></asp:Label>&nbsp;&nbsp;<span class="star">*</span>
                                        <asp:TextBox runat="server" CssClass="form-control RoundText" ID="txtRateContract"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <asp:GridView ID="GridRate" OnRowCommand="GridRate_RowCommand" runat="server" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="RateID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRateID" Text='<%# Eval("RCChargesMasterID") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Rate Code">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRateCode" runat="server" Text='<%# Eval("RCChargesCode") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>                                    
                                    <asp:TemplateField HeaderText="Rate Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRateName" runat="server" Text='<%# Eval("RCChargesName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
