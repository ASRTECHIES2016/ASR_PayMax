<%@ Page Title="" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="Currency.aspx.cs" Inherits="ASR_PayMax.Masters.Currency" %>
                ...
                <ContentTemplate>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="txtCode">Code&nbsp;&nbsp;<span class="star">*</span></label>
                                <asp:TextBox ID="txtCode" CssClass="form-control" runat="server"></asp:TextBox>
                                <input id="hddCurrencyID" type="hidden" runat="server" value="0" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="CurrencyName">Currency Name&nbsp;&nbsp;<span class="star">*</span></label>
                                <asp:TextBox ID="txtCurrencyName" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <asp:Panel ID="pnlButtons" runat="server" CssClass="row">
                        ...
                        <asp:Button ID="Btn_Cancel" runat="server" Text="Reset" CssClass="btn btn-danger" OnClick="Btn_Cancel_Click" />
                                          ...
                                          <hr />
                            <asp:GridView ID="GridCurrency" runat="server" OnRowCommand="GridCurrency_RowCommand" EmptyDataText="No Data Available" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bank ID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBankID" Text='<%# Eval("Str_GlobalID") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bank Branch ID" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBankBranchID" Text='<%# Eval("Str_GlobalID") %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Branch Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBranchName" runat="server" Text='<%# Eval("Str_GlobalName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Bank Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblBankName" runat="server" Text='<%# Eval("Str_GlobalName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
...
<%--          </div>
    ...
    <script type="text/javascript">
        ...
        function auto() {
            ...
            GridMasters('<%=GridCurrency.ClientID%>', '', '', '', '', '', '', '', '', '');
        }
    </script>
</asp:Content>
