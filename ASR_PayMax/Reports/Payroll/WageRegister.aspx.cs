...
{
    public partial class WageRegister : System.Web.UI.Page
    {
        ...
        protected void Btn_Submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _PayMaxParameters = new SiteMasterParameters
                {
                    ...
                    Str_MonthName = ddlMonth.SelectedValue == "Select One" ? "0" : ddlMonth.SelectedItem.Text,//txtDate.Text.Split('-')[1],
                    Str_YearID = ddlYear.SelectedValue == "Select One" ? "0" : ddlYear.SelectedValue,
                    Str_YearName = ddlYear.SelectedValue == "Select One" ? "0" : ddlYear.SelectedItem.Text,//txtDate.Text.Split('-')[0],
                    Str_PaySheetNo = "0",
                ...
                else
                {
                   ...
                   if(_GeneratePdf.GenerateWiseRegister(_GeneratePdf, _PayMaxParameters)!="")
                    {
