...
{
    public partial class OTPGeneration : System.Web.UI.Page
    {


        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["SqlAdminConnString"].ConnectionString);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                txtPhone.Text = string.Format("996 XXXX") + Mobile_no.Substring(Mobile_no.Length - 4, 4);
            }
        }
