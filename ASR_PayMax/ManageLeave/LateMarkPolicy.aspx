<%@ Page Title="Late Mark Policy" Language="C#" MasterPageFile="~/PayMaxMaster.Master" AutoEventWireup="true" CodeBehind="LateMarkPolicy.aspx.cs" Inherits="ASR_PayMax.ManageLeave.LateMarkPolicy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <%-- <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Policy Master</li>
        </ol>
    </section>--%>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">&nbsp;&nbsp;Late Mark Master</h3>
        </div>
        <div class="card-body">
                ...
                <ContentTemplate>
                    <div class="container row">
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <asp:Label CssClass="lblText" runat="server" Text="Policy Name"></asp:Label>&nbsp;&nbsp;<span class="star">*</span>
                                <asp:TextBox ID="txtPolicyName" runat="server" CssClass="form-control" TabIndex="1"></asp:TextBox>
                            </div>
                            <div class="row">
                                <asp:Label CssClass="lblText" runat="server" Text="From Date"></asp:Label>&nbsp;&nbsp;<span class="star">*</span>
                                <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control Date"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-sm-8">
